Shader "WorldsEndWater/Water"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/URPUnderwaterEffects-master/Rendering/Features/Shaders/HLSL/Noise.hlsl"
            #include "Assets/URPUnderwaterEffects-master/Rendering/Features/Shaders/HLSL/Caustics.hlsl"
